    ...
    <div class="Wrapper">
        ...
        <div class="MainContent">
            ...
            if(isset($_GET['ID'])){
                ...
                echo /*LoadQuestions(1);*/ '<h1>Home page</h1><p>Lorem ipsum dolor sit amet consectetur adipiscing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Lacus laoreet non curabitur gravida. 
